...
//   #define __STDC_NO_THREADS__	1
   ...
   || defined(__i386__) || defined(_M_IX86) || (defined(__CODEGEARC__) && !defined(_WIN64))	/* Pentium */
...
// FIXME: had to move
 ...
 #define _CONST_FUN2    _CONST_FUN
#if _HAS_CONSTEXPR
 #define _CONST_FUN1	_CONST_FUN
#else
