...
// (DO NOT EDIT: machine generated header) 'Winapi.Windows.pas' rev: 33.00 (Windows)
...
#pragma pack(push,2)
struct DECLSPEC_DRECORD _IMAGE_DOS_HEADER
{
public:
	System::Word e_magic;
	System::Word e_cblp;
	System::Word e_cp;
	System::Word e_crlc;
	System::Word e_cparhdr;
	System::Word e_minalloc;
	System::Word e_maxalloc;
	System::Word e_ss;
	System::Word e_sp;
	System::Word e_csum;
	System::Word e_ip;
	System::Word e_cs;
	System::Word e_lfarlc;
	System::Word e_ovno;
	System::StaticArray<System::Word, 4> e_res;
	System::Word e_oemid;
	System::Word e_oeminfo;
	System::StaticArray<System::Word, 10> e_res2;
	int _lfanew;
};
#pragma pack(pop)
...
struct DECLSPEC_DRECORD IMAGE_LOAD_CONFIG_DIRECTORY32
{
public:
	unsigned Size;
	...
	unsigned GlobalFlagsClear;
	unsigned GlobalFlagsSet;
	unsigned CriticalSectionDefaultTimeout;
	unsigned DeCommitFreeBlockThreshold;
	unsigned DeCommitTotalFreeThreshold;
	unsigned LockPrefixTable;
	unsigned MaximumAllocationSize;
	unsigned VirtualMemoryThreshold;
	unsigned ProcessHeapFlags;
	unsigned ProcessAffinityMask;
	System::Word CSDVersion;
	System::Word Reserved1;
	unsigned EditList;
	unsigned SecurityCookie;
	unsigned SEHandlerTable;
	unsigned SEHandlerCount;
};


struct DECLSPEC_DRECORD IMAGE_LOAD_CONFIG_DIRECTORY64
{
public:
	unsigned Size;
	unsigned TimeDateStamp;
...
#pragma pack(push,4)
struct DECLSPEC_DRECORD IMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY
{
public:
	unsigned BeginAddress;
	unsigned EndAddress;
	unsigned ExceptionHandler;
	unsigned HandlerData;
	unsigned PrologEndAddress;
};
#pragma pack(pop)
...
typedef _TP_POOL *PTPPool;

typedef _TP_WORK TTPWork;

typedef _TP_WORK *PTPWork;

typedef _TP_TIMER TTPTimer;

typedef _TP_TIMER *PTPTimer;

typedef _TP_IO TTPIO;

typedef _TP_IO *PTPIO;

typedef _TP_CLEANUP_GROUP TTPCleanupGroup;

typedef _TP_CLEANUP_GROUP *PTPCleanupGroup;
...
typedef _RECOVERY_AGENT_INFORMATIONW _RECOVERY_AGENT_INFORMATION;
...
struct DECLSPEC_DRECORD _STARTUPINFOA
{
public:
	unsigned cb;
	char *lpReserved;
	...
	unsigned dwFlags;
	System::Word wShowWindow;
	System::Word cbReserved2;
	System::Byte *lpReserved2;
	NativeUInt hStdInput;
	NativeUInt hStdOutput;
	NativeUInt hStdError;
};


struct DECLSPEC_DRECORD _STARTUPINFOW
{
public:
	unsigned cb;
	System::WideChar *lpReserved;
	System::WideChar *lpDesktop;
	System::WideChar *lpTitle;
	unsigned dwX;
	unsigned dwY;
	unsigned dwXSize;
	unsigned dwYSize;
...
typedef _STARTUPINFOW _STARTUPINFO;
...
typedef _WIN32_FIND_DATAW _WIN32_FIND_DATA;
...
typedef _SLIST_HEADER *PListHeader;
...
typedef tagHW_PROFILE_INFOW tagHW_PROFILE_INFO;
...
typedef tagHW_PROFILE_INFOW HW_PROFILE_INFO;
...
typedef _OSVERSIONINFOW _OSVERSIONINFO;
...
typedef _OSVERSIONINFOEXW _OSVERSIONINFOEX;
...
typedef _HH_FTS_QUERYW _HH_FTS_QUERY;
