...
// (DO NOT EDIT: machine generated header) 'System.TimeSpan.pas' rev: 33.00 (Windows)
...
namespace System { 
namespace Timespan { 
  inline TTimeSpan operator+(const TTimeSpan &Left, const TTimeSpan &Right) 
  { 
    return TTimeSpan::_op_Addition(Left, Right); 
  } 
  inline System::TDateTime operator+(const TTimeSpan &Left, System::TDateTime Right) 
  { 
    return TTimeSpan::_op_Addition(Left, Right); 
  } 
  inline System::TDateTime operator+(const System::TDateTime Left, const TTimeSpan &Right) 
  { 
    return TTimeSpan::_op_Addition(Left, Right); 
  } 
  inline TTimeSpan operator-(const TTimeSpan &Left, const TTimeSpan &Right) 
  { 
      return TTimeSpan::_op_Subtraction(Left, Right); 
  } 
  inline System::TDateTime operator-(const System::TDateTime Left, const TTimeSpan &Right) 
  { 
      return TTimeSpan::_op_Subtraction(Left, Right); 
  } 
  inline bool operator ==(const TTimeSpan &Left, const TTimeSpan &Right) 
  { 
      return TTimeSpan::_op_Equality(Left, Right); 
  } 
  inline bool operator !=(const TTimeSpan &Left, const TTimeSpan &Right) 
  { 
      return TTimeSpan::_op_Inequality(Left, Right); 
  } 
  inline bool operator >(const TTimeSpan &Left, const TTimeSpan &Right) 
  { 
      return TTimeSpan::_op_GreaterThan(Left, Right); 
  } 
  inline bool operator >=(const TTimeSpan &Left, const TTimeSpan &Right) 
  { 
      return TTimeSpan::_op_GreaterThanOrEqual(Left, Right); 
  } 
  inline bool operator <(const TTimeSpan &Left, const TTimeSpan &Right) 
  { 
     return TTimeSpan::_op_LessThan(Left,Right); 
  } 
  inline bool operator <=(const TTimeSpan &Left, const TTimeSpan &Right) 
  { 
     return TTimeSpan::_op_LessThanOrEqual(Left, Right); 
  } 
} 
} 
