...
// (DO NOT EDIT: machine generated header) 'Winapi.WinSpool.pas' rev: 33.00 (Windows)
...
struct DECLSPEC_DRECORD _PRINTER_CONNECTION_INFO_1A
{
public:
	unsigned dwFlags;
	char *pszDriverName;
...
struct DECLSPEC_DRECORD _PRINTER_CONNECTION_INFO_1W
{
public:
	unsigned dwFlags;
	System::WideChar *pszDriverName;
};
