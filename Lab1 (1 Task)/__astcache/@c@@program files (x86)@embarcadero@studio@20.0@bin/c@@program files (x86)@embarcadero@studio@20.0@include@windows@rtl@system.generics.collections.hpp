...
// (DO NOT EDIT: machine generated header) 'System.Generics.Collections.pas' rev: 33.00 (Windows)
...
public:
	...
	__property bool OwnsObjects = {read=FOwnsObjects, write=FOwnsObjects, nodefault};
public:
	/* {System_Generics_Collections}TQueue<System_Generics_Collections_TObjectQueue<T>_T>.Create */ inline __fastcall TObjectQueue__1()/* overload */ : TQueue__1<T>() { }
...
private:
	...
	unsigned FTotalItemsPushed;
	unsigned FTotalItemsPopped;
