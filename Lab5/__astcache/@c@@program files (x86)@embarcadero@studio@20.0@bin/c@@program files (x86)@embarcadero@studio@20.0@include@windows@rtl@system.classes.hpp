...
// (DO NOT EDIT: machine generated header) 'System.Classes.pas' rev: 33.00 (Windows)
...
static const int pidAllPlatforms = int(0x114df);
...
static const System::Int8 pfidAndroid = System::Int8(0x10);
