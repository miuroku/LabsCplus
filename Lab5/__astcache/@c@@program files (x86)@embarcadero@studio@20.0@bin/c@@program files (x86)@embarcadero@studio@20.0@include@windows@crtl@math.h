...
_CRTIMP2 double cos(double);
_CRTIMP2 double cosh(double);
_CRTIMP2 double log(double);
_CRTIMP2 double log10(double);
_CRTIMP2 double sin(double);
_CRTIMP2 double sinh(double);
 ...
 #if _HAS_C99
_CRTIMP2 double log2(double);

 #define log2(x)	_Log(x, -1)
 #endif /* _HAS_C99 */

		/* float MACRO OVERRIDES, FOR C */
_CRTIMP2 float cosf(float);
_CRTIMP2 float coshf(float);
_CRTIMP2 float logf(float);
_CRTIMP2 float log10f(float);
_CRTIMP2 float sinf(float);
_CRTIMP2 float sinhf(float);
 ...
 #if _HAS_C99
_CRTIMP2 float log2f(float);

 #define log2f(x)	_FLog(x, -1)
 #endif /* _HAS_C99 */

		/* long double MACRO OVERRIDES, FOR C */
_CRTIMP2 long double cosl(long double);
_CRTIMP2 long double coshl(long double);
_CRTIMP2 long double logl(long double);
_CRTIMP2 long double log10l(long double);
_CRTIMP2 long double sinl(long double);
_CRTIMP2 long double sinhl(long double);
 ...
 #if _HAS_C99
_CRTIMP2 long double log2l(long double);
