...
// (DO NOT EDIT: machine generated header) 'Winapi.ShellAPI.pas' rev: 33.00 (Windows)
...
public:
	...
	Winapi::Windows::_STARTUPINFOW *lpStartupInfo;
...
typedef OPEN_PRINTER_PROPS_INFOW _OPEN_PRINTER_PROPS_INFO;
