...
// (DO NOT EDIT: machine generated header) 'System.Rtti.pas' rev: 33.00 (Windows)
...
public:
	...
	virtual System::UnicodeString __fastcall ToString();
protected:
	/* TRttiObject.Create */ inline __fastcall virtual TRttiField(TRttiPackage* APackage, TRttiObject* AParent, System::PByte &P) : TRttiMember(APackage, AParent, P) { }
...
private:
	...
	public:
		...
		bool FConstant;
		int FOffset;
		__fastcall TParamLoc(System::Typinfo::PTypeInfo AType, bool AByRef, bool AConstant);
		void * __fastcall GetArgLoc(TMethodImplementation::PInterceptFrame AFrame);
		void __fastcall GetArg(TMethodImplementation::PInterceptFrame AFrame, /* out */ TValue &Value);
...
#endif /* _WIN64 */
		void __fastcall AddParameter(System::Typinfo::PTypeInfo AType, bool AByRef, bool AConstant);
